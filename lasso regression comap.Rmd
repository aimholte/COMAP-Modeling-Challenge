...
AZlm <- tslm(RETCB ~ MGACB + FFTCB + TETCB + ELNIB + ELISB + 
    NUETV + PATXB + CLICD + NGACD + CLKCV, data = tsAZ)
CAlm <- tslm(RETCB ~ MGACB + FFTCB + TETCB + ELNIB + ELISB + 
    NUETV + PATXB + CLICD + NGACD + CLKCV, data = tsCA)
NMlm <- tslm(RETCB ~ MGACB + FFTCB + TETCB + ELNIB + ELISB + 
    NUETV + PATXB + CLICD + NGACD + CLKCV, data = tsNM)
TXlm <- tslm(RETCB ~ MGACB + FFTCB + TETCB + ELNIB + ELISB + 
...
```{r}
#par(mfrow = c(2,2))
plot(modeldataAZ$Year, modeldataAZ$RETCB, pch = 20, main = "Arizona's Green Energy Consumption", xlab ="Year", ylab = "Consumption (Billions of BTU")
lines(modeldataAZ$Year, AZlm$fitted.values, col = "red")
plot(modeldataCA$Year, modeldataCA$RETCB, pch = 20, main = "California's Green Energy Consumption", xlab ="Year", ylab = "Consumption (Billions of BTU")
lines(modeldataCA$Year, CAlm$fitted.values, col = "red")
plot(modeldataNM$Year, modeldataNM$RETCB, pch = 20, main = "New Mexico's Green Energy Consumption", xlab ="Year", ylab = "Consumption (Billions of BTU")
lines(modeldataNM$Year, NMlm$fitted.values, col = "red")
plot(modeldataTX$Year, modeldataTX$RETCB, pch = 20, main = "Texas' Green Energy Consumption", xlab ="Year", ylab = "Consumption (Billions of BTU")
