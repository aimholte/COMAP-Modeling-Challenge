...
```{r}
names2 <- c("Motor Gasoline Consumption (Transportation)", "Fossil Fules Consumption", "Total Energy Consumption", "U.S. Electricity Net Imports", "Net Electricity Interstate Sales", "Nuclear Fuel Expenditure", "Petroleum Product Consumption", "Coal Price (Industrial)", "Natural Gas Price (Transportation)", "Coal Expenditure (Coke Plants)")
...
elasticiites.df <- elasticiites.df[,6:10]
```
